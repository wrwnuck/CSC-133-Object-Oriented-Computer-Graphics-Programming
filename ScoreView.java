...
public class ScoreView extends Container implements Observer {
	...
	public void setupLabels() {
		...
		lastBaseValue = new Label("" + model.getCyborgBaseReached());
		...
		healthLevelValue = new Label("" + model.getCyborgHealthLevel());
