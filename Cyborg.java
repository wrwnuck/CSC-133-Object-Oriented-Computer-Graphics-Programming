// Cyborg class is the player moveable object where which can be damaged and move in the game world
...
public class Cyborg extends Movable implements ISteerable{
	 ...
	 * @param y
	 */
	public Cyborg(GameWorld gw,int size, int heading,double x, double y) {//
		super(gw,size, x, y);
		super.setSpeed(10);
	...
	@Override
	public void setSpeed(int speed) {//sets the speed of cyborg
		if(speed <= (maximumSpeed) && speed >=0 )
			super.setSpeed(speed);
	}
	public void checkSpeed() {//checks the speed when the cyborg takes damage
	...
	public void collision(char with) {//Called when a collision with a drone or cyborg is detected. sets damage and color accordenly 
		if(damageLevel!=100) {
